...
public class SVMMorphologicalDisambiguatorLexical extends AbstractDiscriminativeDisambiguator{
	
	public SVMMorphologicalDisambiguatorLexical(ArrayList<String> trainOptions, String featureParameterFile)
	{
	...
	public void train(ArrayList<String> traininginputfiles) {
		...
		//problems.determineProblemSetWithSimilarityMetric(traininginputfiles.get(0));
